      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Para acessar sua conta, você precisa confirmar seu endereço de
            email.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="rounded-lg bg-[#21252b] p-4 text-sm text-gray-400">
            <p>
              Enviamos um link de verificação para o seu email. Clique no link
          ...
          <div className="space-y-3 mt-4">
            <Button onClick={resendEmail} className="w-full bg-[#5593f7]">
