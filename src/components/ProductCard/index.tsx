...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    <div className="group overflow-hidden hover:shadow-lg transition-all duration-300  backdrop-blur-sm rounded-lg bg-[#181c22] ">
      ...
      <div className="p-4">
        <div className="space-y-2">
          ...
          <StarsRating rating={product.rating} reviews={product.reviews} />
