...
export default function RegisterForm() {
  ...
  return (
    ...
    from-[#181b20cc] to-[#1d2025e6] border border-[#2c313a]/50 backdrop-blur-lx shadow-[#181b1f] rounded-lg text-gray-400"
    >
      <div className="p-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-[#5593f7] to-[#1d4fd7] text-transparent bg-clip-text">
            Criar conta
          </h2>
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <CustomButton
              variant="outline"
              className="text-sm hover:bg-[#44B7F4]"
            >
              <FaChrome size={20} />
              Continuar Google
            </CustomButton>
          ...
          <div className="text-center mt-6 flex items-center justify-center gap-2">
            ...
            <Link
              href={"/"}
              className="text-sm text-[#5553f7] hover:text-[#5553f7]/80 transition-colors"
            >
              Fazer Login
            </Link>
          </div>
